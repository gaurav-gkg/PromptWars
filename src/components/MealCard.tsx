  ...
  return (
    <article className="bg-[#ffffff] dark:bg-[#1a1c1c] rounded-[24px] shadow-[0_1px_3px_rgba(0,0,0,0.08)] border border-[#bfcaba]/40 overflow-hidden flex flex-col group hover:shadow-md transition-shadow duration-200">
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="sm:w-1/3 min-h-[160px] sm:min-h-auto relative bg-[#eeeeee] dark:bg-[#2f3131] flex flex-col items-center justify-center p-4 text-center">
          <div className="absolute top-2 left-2 bg-[#ffffff]/90 dark:bg-[#1a1c1c]/90 backdrop-blur-sm text-[#1a1c1c] dark:text-[#ffffff] px-2 py-1 rounded-full font-medium text-[11px] tracking-wider uppercase flex items-center gap-1 shadow-sm">
            <span className="material-symbols-outlined text-[14px]">{icon}</span>
            {type}
          </div>
          
          <span className="material-symbols-outlined text-[48px] text-[#0d631b] dark:text-[#a3f69c] mb-2">
            {type === "Breakfast" ? "cookie" : type === "Lunch" ? "rice_bowl" : "dinner_dining"}
          </span>
          <h3 className="font-semibold text-lg text-[#1a1c1c] dark:text-[#ffffff] px-2">{meal.name}</h3>
        </div>
        ...
        <div className="p-4 sm:p-6 sm:w-2/3 flex flex-col justify-between">
          <div>
            ...
            <p className="text-[#40493d] dark:text-[#bfcaba] text-sm mb-4 line-clamp-2">
              {meal.description}
            </p>
          </div>

          <div className="flex items-center gap-2 flex-wrap">
            <div className="flex items-center gap-1 text-[#40493d] dark:text-[#bfcaba] bg-[#f3f3f3] dark:bg-[#2f3131] py-1 px-2 rounded-md">
            ...
            {meal.dietaryTag && (
              <div className="flex items-center gap-1 text-[#0d631b] dark:text-[#a3f69c] bg-[#cbffc2]/30 dark:bg-[#2e7d32]/20 py-1 px-2 rounded-md">
            ...
            <button
              ...
              className="ml-auto flex items-center gap-1 text-[#0d631b] dark:text-[#a3f69c] font-semibold text-sm hover:underline"
            >
      ...
      {isExpanded && (
        <div className="border-t border-[#bfcaba]/30 p-4 sm:p-6 bg-[#f9f9f9] dark:bg-[#1a1c1c]/40 animate-[fadeIn_0.2s_ease-out]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Ingredients */}
            <div>
              <h4 className="font-semibold text-[#1a1c1c] dark:text-[#ffffff] text-sm mb-2 flex items-center gap-1">
