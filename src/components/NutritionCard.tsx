  ...
  return (
    <section className="bg-[#ffffff] dark:bg-[#1a1c1c] rounded-[24px] shadow-[0_1px_3px_rgba(0,0,0,0.08)] border border-[#bfcaba]/40 p-4 flex flex-col gap-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-1">
        {/* Calories */}
        <div className="flex flex-col items-center justify-center p-1 bg-[#f9f9f9] dark:bg-[#2f3131]/20 rounded-xl">
      ...
      {/* Tonal Ratio bar */}
      <div className="mt-2">
        <h4 className="text-[11px] text-[#40493d] dark:text-[#bfcaba] font-semibold mb-1 uppercase tracking-wider">Macro Ratio</h4>
        ...
        <div className="flex justify-between text-[10px] text-[#707a6c] dark:text-[#bfcaba] mt-1">
