...
export function BudgetCard({ estimatedCost, budgetAnalysis, limit }: BudgetCardProps) {
  ...
  return (
    <section className="bg-[#ffffff] dark:bg-[#1a1c1c] rounded-[24px] shadow-[0_1px_3px_rgba(0,0,0,0.08)] border border-[#bfcaba]/40 p-md flex flex-col gap-sm">
      ...
      <div className="mt-sm">
        <div className="flex justify-between text-[11px] font-semibold mb-xs">
        ...
        <p className="text-xs text-[#40493d] dark:text-[#bfcaba] mt-sm">
          {isFeasible 
      ...
      {budgetAnalysis.savingsSuggestions && budgetAnalysis.savingsSuggestions.length > 0 && (
        <div className="mt-md border-t border-[#f3f3f3] pt-md bg-[#f3f3f3]/20 dark:bg-[#2f3131]/20 p-sm rounded-xl">
          <div className="flex items-center gap-xs mb-xs text-[#0d631b] dark:text-[#a3f69c] font-semibold text-xs">
